module systemFsub_records_invoke.
...
step (invoke E1 L E3) (invoke E1' L E3) :- step E1 E1'.

step (invoke E1 L E3) (invoke E1 L E3') :- step E3 E3', value E1.
...
subtype (recordT (consT_record L T1 Rest1)) (recordT (consT_record L T1' Rest1')) :- subtype T1 T1', subtype (recordT Rest1) (recordT Rest1').
