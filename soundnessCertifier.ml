...
(* Implicitly Typed Lambda Calculus with letrec with no type annotations *)
("itlc_cbn_letrecFix", itlc_cbn_letrecFix) ;
("itlc_cbv_letrecFix", itlc_cbv_letrecFix) ;
("itlc_par_letrecFix", itlc_par_letrecFix) ;
(* STLC with sums *)
...
("lambdafull_cbn", lambdafull_cbn) ;
("lambdafull_cbv", lambdafull_cbv) ;
("lambdafull_par", lambdafull_par) ;
